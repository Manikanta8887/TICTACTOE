...
const Board = ({ grid, onDrop, currentTurn, winner }) => {
  return (
    <motion.div
      className="grid grid-cols-3 gap-4 bg-orange-400 p-5 rounded-2xl border-4 border-yellow-300 shadow-2xl"
      style={{
        width: 'max-content',
        margin: 'auto',
        boxShadow: '0 0 40px rgba(255, 165, 0, 0.7)', // Extra neon glow
      }}
      aria-label="Game board"
      variants={boardVariants}
      initial="hidden"
